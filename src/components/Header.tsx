    ...
    <header className="border-b border-[var(--border)] bg-white/90 backdrop-blur">
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
        ...
        <nav className="flex items-center gap-3 text-sm">
          ...
          <Link href="/reservations/new" className="btn btn-primary px-3 py-2 text-sm">
            예약하기
          </Link>
          <Link href="/reservations" className="btn btn-secondary px-3 py-2 text-sm">
            내 예약
          </Link>
          <Link href="/history" className="btn btn-secondary px-3 py-2 text-sm">
            히스토리
          </Link>
          <Link href="/account" className="btn btn-secondary px-3 py-2 text-sm">
            PIN 변경
          </Link>
          <LogoutButton />
        </nav>
